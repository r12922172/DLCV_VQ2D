...
def validate_model_predictions(model_predictions, test_annotations):
    ...
    for clip_name, c in test_annotations:
    ...
    for vannot, vpred in zip(test_annotations, model_predictions):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gt-file", required=False, type=str, default='/data/jason/DLCV_vq2d_data/vq_val.json')
