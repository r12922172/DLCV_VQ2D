...
class QueryVideoDataset(Dataset):
    def __init__(self,
                 ...
                 query_params,
                 clip_params,
                 data_dir= '/data/jason/DLCV_vq2d_data', #'/vision/hwjiang/episodic-memory/VQ2D/data',
                 clip_dir= '/data/jason/DLCV_vq2d_data/clips',  #'/vision/vision_data/Ego4D/v1/clips_320p',
                 meta_dir= '/data/jason/DLCV_vq2d_data', #'/vision/hwjiang/episodic-memory/VQ2D/data',
                 split='train',
    ...
    def _load_metadata(self):
        ...
        if os.path.isfile(anno_processed_path):
            ...
            for clip_id, clip_data in anno_json.items():
                ...
                for clip_anno in clip_data['annotations']:
                    for qset_id, qset in clip_anno['query_sets'].items():
                        ...
                        curr_anno = {
                            ...
                            # },
                            "clip_uid": clip_id, # clip_data["clip_uid"],
                            # "clip_fps": clip_data["clip_fps"],
                            "query_set": qset_id,
                        ...
                        if clip_id == '859ed253-d752-4f1b-adc3-c76599117d6e':
                            print(query_path)
                        if os.path.isfile(query_path):
                            self.annotations.append(curr_anno)
                            n_samples_valid += 1
                        elif self.split == 'train' and clip_id == '859ed253-d752-4f1b-adc3-c76599117d6e':
