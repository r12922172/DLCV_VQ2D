...
def resume_training(model, optimizer, schedular, scaler, output_dir, cpt_name='cpt_last.pth.tar', strict=True, device=None):
    ...
    output_dir = '/home/r12922169/course/dlcv/final/DLCV-Fall-2023-Final-2-deeeeeeeep/VQLoC/output_fine/ego4d_vq2d/train/train/3j3q9qsc1kovpwfxtnsful7pvdy234q6.tar'
